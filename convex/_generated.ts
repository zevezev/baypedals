/* eslint-disable */
// Generated by convex-dev@0.1.2
// based on the contents of this directory.
// To regenerate, run `convex codegen`.
import type deleteAllPosts from "./deleteAllPosts";
import type getPosts from "./getPosts";
import type uploadPost from "./uploadPost";
...
export type ConvexAPI = {
  queries: {
    getPosts: ClientQuery<typeof getPosts>;
  };
  mutations: {
    deleteAllPosts: ClientMutation<typeof deleteAllPosts>;
    uploadPost: ClientMutation<typeof uploadPost>;
  };
};
